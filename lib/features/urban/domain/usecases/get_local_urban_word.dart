...
class GetLocalUrbanWord extends UsecaseWithoutParams<List<UrbanWord>> {
  GetLocalUrbanWord({required UrbanWordRepository repository})
      : _repository = repository;
  final UrbanWordRepository _repository;
  @override
  ResultFuture<List<UrbanWord>> call() async => _repository.getLocalUrbanWord();
}
